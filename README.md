# Zspace Servers [Eggs we use or condone]

We grab these eggs from accross the internet or make them ourselves, these eggs are eggs we trust and use on a regular basis for our hosting neeeds.
...
## [Stock Eggs](/stock_eggs)
This holds all the default eggs for pterodactyl panel.
